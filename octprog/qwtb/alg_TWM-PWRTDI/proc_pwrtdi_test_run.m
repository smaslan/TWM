function [res] = proc_pwrtdi_test_run(par)
% This is inner execution unit of TWM-PWRTDI validation.
% It will load the test parameters and execute TWM-PWRTDI algorithm once, returns pass/fail.
