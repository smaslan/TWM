...
% Part of QWTB. Info script for algorithm TWM-TIAZ.
%
...
% See also qwtb
    ...
    alginfo.inputs(pid).desc = 'Set for inverting TIA';
    alginfo.inputs(pid).alternative = 0;
    alginfo.inputs(pid).optional = 1;
    alginfo.inputs(pid).parameter = 1;
    pid = pid + 1;
    ...
    % transducer buffer output Z
    alginfo.inputs(pid).name = 'Zbuf_Rs';
    alginfo.inputs(pid).desc = 'Transducer buffer series output impedance: series resistance';
    alginfo.inputs(pid).alternative = 0;
    alginfo.inputs(pid).optional = 1;
    alginfo.inputs(pid).parameter = 0;
    pid = pid + 1;
    ...
    alginfo.inputs(pid).name = 'Zbuf_Ls';
    alginfo.inputs(pid).desc = 'Transducer buffer series output impedance: series inductance';
    alginfo.inputs(pid).alternative = 0;
    alginfo.inputs(pid).optional = 1;
    alginfo.inputs(pid).parameter = 0;
    pid = pid + 1;
    ...
    alginfo.outputs(pid).name = 'Itia';
    alginfo.outputs(pid).desc = 'TIA RMS current [A]';
    pid = pid + 1;
    ...
    alginfo.outputs(pid).desc = 'TIA DC current [A]';
    pid = pid + 1;
    ...
    alginfo.outputs(pid).desc = 'TIA current spectrum';
    pid = pid + 1;
