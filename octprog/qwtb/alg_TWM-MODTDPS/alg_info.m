...
% See also qwtb
    ...
    % --- parameters:
    alginfo.inputs(pid).name = 'wave_shape';
    alginfo.inputs(pid).desc = 'Expected shape of the modulation envelope (''sine'' or ''rect'')';
    alginfo.inputs(pid).alternative = 0;
    alginfo.inputs(pid).optional = 1;
...
%     pid = pid + 1;
    ...
    alginfo.outputs(pid).desc = 'Frequency of the carrier';
    pid = pid + 1;
    
    alginfo.outputs(pid).name = 'A0';
...
%     pid = pid + 1;
    ...
    alginfo.outputs(pid).name = 'A_mod';
    alginfo.outputs(pid).desc = 'Modulating amplitude';
    pid = pid + 1;
    
    alginfo.outputs(pid).name = 'mod';
    alginfo.outputs(pid).desc = 'Modulating depth [%]';
    pid = pid + 1;
    
    alginfo.outputs(pid).name = 'dVV';
    alginfo.outputs(pid).desc = 'Delta V/V [%]';
    pid = pid + 1;
    ...
    alginfo.outputs(pid).name = 'env_t';
    alginfo.outputs(pid).desc = 'Modulation envelope - time vector';
    pid = pid + 1;
