...
<Library LVVersion="20008000">
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Configure" Type="Folder">
			...
			<Item Name="Configure Standard Waveform - Basic.vi" Type="VI" URL="../Public/Configure/Configure Standard Waveform - Basic.vi"/>
			<Item Name="Configure Standard Waveform Frequency.vi" Type="VI" URL="../Public/Configure/Configure Standard Waveform Frequency.vi"/>
			...
			<Item Name="Configure Waveform Length.vi" Type="VI" URL="../Public/Configure/Configure Waveform Length.vi"/>
			<Item Name="Configure Waveform Modifier.vi" Type="VI" URL="../Public/Configure/Configure Waveform Modifier.vi"/>
			<Item Name="Configure Waveform Points.vi" Type="VI" URL="../Public/Configure/Configure Waveform Points.vi"/>
		...
		<Item Name="Utility" Type="Folder">
			<Item Name="Memory" Type="Folder">
				<Item Name="Query Waveform Length.vi" Type="VI" URL="../Public/Utility/Memory/Query Waveform Length.vi"/>
				<Item Name="Query Waveform Points.vi" Type="VI" URL="../Public/Utility/Memory/Query Waveform Points.vi"/>
				<Item Name="Save Load Mass Storage Waveform.vi" Type="VI" URL="../Public/Utility/Memory/Save Load Mass Storage Waveform.vi"/>
				<Item Name="Setup Memory.vi" Type="VI" URL="../Public/Utility/Memory/Setup Memory.vi"/>
			</Item>
			...
			<Item Name="Save Load Instrument Settings.vi" Type="VI" URL="../Public/Utility/Save Load Instrument Settings.vi"/>
		</Item>
	...
	<Item Name="Private" Type="Folder">
		...
		<Item Name="Scale.vi" Type="VI" URL="../Private/Scale.vi"/>
	</Item>
</Library>
