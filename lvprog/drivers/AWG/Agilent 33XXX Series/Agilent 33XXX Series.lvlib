...
<Library LVVersion="13008000">
	...
	<Item Name="Public" Type="Folder">
		...
		<Item Name="Action-Status" Type="Folder">
			...
			<Item Name="PLL Lock.vi" Type="VI" URL="../Public/Action-Status/PLL Lock.vi"/>
		</Item>
		<Item Name="Configure" Type="Folder">
			...
			<Item Name="Configure Modulation (Burst).vi" Type="VI" URL="../Public/Configure/Configure Modulation (Burst).vi"/>
			...
			<Item Name="Configure Pulse.vi" Type="VI" URL="../Public/Configure/Configure Pulse.vi"/>
		...
		<Item Name="Utility" Type="Folder">
			...
			<Item Name="Get Model ID.vi" Type="VI" URL="../Public/Utility/Get Model ID.vi"/>
		</Item>
